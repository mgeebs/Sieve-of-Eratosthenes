TITLE pa7.asm
; Author: Michael Hedrick 107045292
...
.data
	;numOfPrimes BYTE ? ;variable will hold the number of primes between 0 and 2000
...
.code
	...
	call writeChar
	call writeChar			;sloppy but it works so I don't have to spend hours on stupid easy stuff
	mov eax, numTwo
	call WriteDec
